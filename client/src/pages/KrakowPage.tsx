...
export default function KrakowPage() {
  return (
    <>
      <Helmet>
        <title>Agencja Neuromarketingowa w Krakowie - CRO & SEO</title>
        <meta name="robots" content="index, follow" />
        <meta name="description" content="Agencja Neuromarketingowa w Krakowie. Specjalizujemy się w CRO, SEO i Decision Science. Zwiększamy ROAS e-commerce o 150% w 90 dni." />
        <meta name="keywords" content="agencja neuromarketingowa kraków, agencja seo kraków, agencja marketingowa kraków, cro kraków, pozycjonowanie kraków" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://boostnow.pl/krakow" />
        <meta property="og:title" content="Agencja Neuromarketingowa w Krakowie" />
        <meta property="og:description" content="Agencja Neuromarketingowa w Krakowie - CRO, SEO i Decision Science. Zwiększamy ROAS e-commerce o 150% w 90 dni." />
        <link rel="canonical" href="https://boostnow.pl/krakow" />
      </Helmet>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="py-12 md:py-16">
            <div className="mb-6 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-lime-400/10 border border-lime-400/30">
              ...
              <span className="text-sm font-semibold text-lime-400">KRAKÓW</span>
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Agencja Neuromarketingowa w Krakowie
            </h1>

            <p className="text-xl text-gray-400 mb-8 leading-relaxed">
              Specjalizujemy się w optymalizacji konwersji, SEO i neuromarketingu dla e-commerce. Obsługujemy klientów z Krakowa i całej Polski.
            </p>
          ...
          <div className="prose prose-invert max-w-none space-y-8 text-gray-300 py-12">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-6">Dlaczego BoostNow w Krakowie?</h2>
              <p className="text-lg leading-relaxed mb-6">
                BoostNow to agencja neuromarketingowa, która łączy psychologię, data science i optymalizację konwersji. Pracujemy z markami z Krakowa i całej Polski, pomagając im zwiększać sprzedaż o 150% w 90 dni.
              </p>
            ...
            {/* Section 2 */}
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-6">Nasze Usługi w Krakowie</h2>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle size={20} className="text-lime-400 flex-shrink-0 mt-1" />
                  <span>Firmy z Krakowa i całej Polski</span>
                </li>
              </ul>
            </section>
            ...
            {/* Section 4 */}
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-6">Kontakt w Krakowie</h2>
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Obsługujemy klientów z Krakowa i całej Polski online</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
