...
| Cecha | Tradycyjne CRO | Metodologia Architektów Decyzji |
| :--- | :--- | :--- |
| **Główny cel** | Optymalizacja elementów strony | Projektowanie decyzji klienta |
| **Podstawa** | Testy A/B, analiza danych technicznych | Psychologia poznawcza, ekonomia behawioralna |
| **Pytanie kluczowe** | Co działa lepiej? | Co blokuje klienta? |
| **Oczekiwany wzrost** | Przyrostowy (kilka procent) | Skokowy (kilkaset procent) |
| **Kluczowy wskaźnik** | Współczynnik konwersji | Redukcja tarcia decyzyjnego |
